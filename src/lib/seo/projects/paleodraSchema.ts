...
const paleodraSoftwareEntity: SoftwareSourceCode = {
  ...
  name: 'paleodra',
  description: 'A dinosaur discovery web application that allows users to explore, learn, and track dinosaur species.',
  url: 'https://github.com/vikiru/paleodra',
  author: { '@id': personId },
  maintainer: { '@id': personId },
  keywords: ['paleodra', 'nextjs', 'react', 'typescript', 'dinosaur', 'discovery'],
  version: '1.0.0',
...
export const paleodraData = [paleodraSoftwareEntity, paleodraWebsiteEntity, ...restasaurusData];
