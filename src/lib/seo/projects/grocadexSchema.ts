...
const softwareEntity: SoftwareSourceCode = {
  ...
  name: 'grocadex',
  description: 'A React Native mobile app to track grocery expiry dates and expenses.',
  url: 'https://github.com/vikiru/grocadex',
  author: { '@id': personId },
  maintainer: { '@id': personId },
  keywords: ['react native', 'expo', 'gluestack', 'nativewind', 'zustand', 'tanstack', 'prisma', 'postgresql'],
  version: '1.0.1',
...
const websiteEntity: WebSite = {
  ...
  description: 'Documentation for Grocadex - A React Native mobile app to track grocery expiry dates and expenses.',
