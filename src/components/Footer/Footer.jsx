    ...
    <footer className="mt-auto w-full">
      <div className="bg-secondary xxs:flex xxs:flex-col md:grid md:grid-cols-3 dark:bg-darkPrimary">
        <div className="m-auto">
          <h2 className="font-cinzel tracking-widest text-primary xxs:text-lg  md:text-3xl lg:text-4xl xl:text-5xl dark:text-darkSecondary">
            <span className="text-primary dark:text-darkSecondary  dark:text-darkSecondary">
              Visa
            </span>
        ...
        <div>
          <h2 className="text-center font-heading text-xl uppercase text-primary lg:text-2xl  dark:text-darkSecondary dark:text-darkSecondary">
            Read More
          </h2>
          {navData.map((navItem) => (
            <div key={navItem} className="mx-auto w-20">
              <Link to={navItem.navLink}>
                <h2 className="text-center font-body text-lg uppercase text-primary hover:underline  lg:text-xl dark:text-darkSecondary dark:text-darkSecondary dark:decoration-darkAccent">
                  {navItem.navTitle}
                </h2>
              </Link>
            </div>
      ...
      <div className="bg-secondary dark:bg-darkPrimary">
        <div className="mx-auto flex max-w-lg items-center justify-center py-2">
          <span className="text-center font-heading font-thin text-primary lg:text-lg dark:text-darkSecondary  dark:text-darkSecondary">
