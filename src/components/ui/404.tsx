    ...
    <Layout>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-9xl space-y-4 text-center">
          ...
          <div>
            <h1 className="font-heading text-h2 font-bold tracking-tight text-foreground">Page Not Found</h1>
          </div>

          <div>
            <p className="body-base text-muted-foreground">The page you are looking for does not exist.</p>
