...
export function SitemapGrid({ children, cols = 2, className }: SitemapGridProps) {
  const gridStyles = {
    1: "grid-cols-1",
  ...
  return <div className={cn("grid gap-3 md:gap-4", gridStyles[cols], className)}>{children}</div>;
}
