          ...
          <CardContent className="flex flex-col items-start gap-12 p-8 lg:flex-row">
            <div className="flex-1">
              <p className="body-large mb-6 leading-relaxed text-muted-foreground">
                Feel free to send me an email using the contact form, I will try to respond to you as soon as possible.
                In case, the form does not work for any reason, please{' '}
                <a
