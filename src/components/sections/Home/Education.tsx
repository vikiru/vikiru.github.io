...
export function Education({ className }: EducationProps) {
  ...
  return (
    <section className={cn('py-20 bg-muted/30', className)} id="education">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-12">
          <h2 className="text-h2 font-bold mb-4 flex items-center gap-3 font-heading">
          ...
          <Card className="hover:border-primary/30 transition-all duration-300 motion-reduce:transition-none">
            <CardContent className="p-6 flex flex-col h-full">
              ...
              <div className="mt-auto pt-6 border-t border-border">
                <Link
                  className="inline-flex items-center gap-2 text-primary hover:text-accent transition-colors group/link text-sm font-medium motion-reduce:transition-none"
                  to="/education/courses"
                >
                  View Courses
                  <LuArrowRight className="text-sm group-hover/link:translate-x-1 transition-transform motion-reduce:transition-none motion-reduce:group-hover/link:translate-x-0" />
                </Link>
              </div>
            </CardContent>
          </Card>
                ...
                {certificates.map((cert) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="ml-auto text-muted-foreground group-hover:text-accent transition-colors p-2 rounded-full motion-reduce:transition-none">
                        <LuLink className="text-lg block" />
                      </span>
                    </a>
                  </li>
                ))}
