...
function NavBar() {
    ...
    return (
        <nav className="bg-light-background-600 dark:bg-dark-background-800">
            ...
            <section
                className={`fixed right-0 top-0 h-full w-3/4 bg-light-background-600 text-white transition-all duration-500 ease-in-out md:hidden dark:bg-dark-background-800  ${
