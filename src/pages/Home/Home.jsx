    ...
    <div className="flex h-screen w-screen snap-y flex-col overflow-x-hidden overflow-y-scroll scroll-smooth bg-primary scrollbar scrollbar-track-primary scrollbar-thumb-secondary dark:bg-darkPrimary">
      ...
      <main className="py-4">
        <div className="flex justify-center">
          <h2 className="text-center font-cinzel tracking-widest text-secondary lg:text-6xl dark:text-darkSecondary">
            {aboutData.fullName}
          </h2>
        </div>
        ...
        <div className="mx-auto flex max-w-lg justify-center">
          <h3 className="font-subheading font-thin text-secondary lg:text-4xl dark:text-darkSecondary ">
            {aboutData.title}
          </h3>
        </div>
        ...
        <div className="mx-auto max-w-xl py-1">
          <p className="text-center font-body text-secondary xxs:text-sm lg:text-3xl dark:text-darkSecondary ">
        ...
        <div className="flex gap-2 xxs:flex-col lg:flex-row lg:justify-center lg:py-4">
          <div className="bg-blue-400 rounded-full bg-accent p-2 hover:cursor-pointer hover:ring-4 md:mx-auto lg:mx-0 lg:w-60 dark:bg-darkAccent">
            <a href="/about" target="_blank" rel="noopener noreferrer">
              <h2 className="text-center uppercase text-secondary lg:text-2xl dark:text-darkSecondary ">
                Read More
              </h2>
            </a>
          </div>
          <div className="rounded-full bg-accent hover:cursor-pointer hover:ring-4 md:mx-auto lg:mx-0 lg:w-60 lg:px-2 xl:p-2 dark:bg-darkAccent">
            <a href="/projects" target="_blank" rel="noopener noreferrer">
              <h2 className="text-center uppercase tracking-widest text-secondary lg:text-2xl dark:text-darkSecondary ">
                View My Work
              </h2>
            </a>
          </div>
          <div className="rounded-full bg-accent p-2 hover:cursor-pointer hover:ring-4 md:mx-auto lg:mx-0 lg:w-60 dark:bg-darkAccent">
            <a
              href="mailto:viskirubakaran@outlook.com"
              target="_blank"
              rel="noopener noreferrer"
